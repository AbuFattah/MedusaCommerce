    ...
    <div className="flex gap-x-8 gap-y-16 justify-center flex-wrap">
      ...
      >
        <div className="relative w-full h-40">
          <div className="absolute inset-0 bg-black opacity-5 rounded-md z-40"></div>
          <Image
            src="/products/aptamil1.jpg"
            fill
            className="absolute object-cover rounded-md z-20 hover:opacity-0 transition-opacity ease-out duration-500 text-center"
            alt=""
          />
          <button
